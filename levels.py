...
class Level(all_levels):
    def __init__(self, lvl):
        level_items = eval(f"Level{lvl}().level_items")
        super().__init__(level_items, (12, 8))
        for tile_type, tiles in self.level_items.items():
            for tile in tiles:
                eval(f"self.{tile_type}.create_tile(*tile)")
...
class Level1():
    ...
    def __init__(self):
        ...
        self.doors.create_tile(self.door_start)
        self.level_items = defaultdict(list)

        self.level_items["gems"] = [
            ("trophy", (11, 2)),
            ("blue_gem", (1, 6)),
            ("blue_gem", (7, 6)),
            ("red_gem", (17, 1)),
        ...
        for i in range(4):
            if not i == 2:
                self.level_items["gems"].append(("blue_gem", (3 + i * 4, 2)))
        for i in range(5):
            self.level_items["gems"].append(("blue_gem", (1 + 4 * i, 4)))

        self.level_items["tiles"] = [("horizontal_pipe", (1, 8)), ("red_brick", (11, 8))]
        for i in range(4):
            self.level_items["tiles"].append(("red_brick", (3 + i * 4, 3)))
        for i in range(5):
            self.level_items["tiles"].append(("red_brick", (1 + i * 4, 5)))
        for i in range(4):
            self.level_items["tiles"].append(("red_brick", (4 + i, 7)))
        for i in range(6):
            self.level_items["tiles"].append(("red_brick", (11 + i, 7)))

        for i in range(20):
            self.level_items["tiles"].append(("red_brick", (i, 0)))
        for i in range(20):
            self.level_items["tiles"].append(("red_brick", (i, 9)))
        for j in range(10):
            self.level_items["tiles"].append(("red_brick", (0, j)))
        for j in range(10):
            self.level_items["tiles"].append(("red_brick", (18, j)))
        for j in range(10):
            self.level_items["tiles"].append(("dirt", (19, j)))
...
class Level2:
    ...
    def __init__(self):
        ...
        for i in range(5):
            self.level_items["gems"].append(("blue_gem", (16 + i, 7)))

        self.level_items["tiles"] = [("horizontal_pipe", (1, 8))]
        for j in range(10):
            self.level_items["tiles"].append(("red_brick", (0, j)))
        for j in range(5):
            self.level_items["tiles"].append(("red_brick", (9, j + 5)))
        for j in range(6):
            self.level_items["tiles"].append(("red_brick", (14, j + 4)))
        for j in range(5):
            self.level_items["tiles"].append(("red_brick", (22, j + 4)))
        for i in range(50):
            self.level_items["tiles"].append(("red_brick", (i, 0)))
        for i in range(5):
            self.level_items["tiles"].append(("red_brick", (i + 24, 2)))
        for i in range(9):
            self.level_items["tiles"].append(("red_brick", (i + 26, 4)))
        for j in range(3):
            self.level_items["tiles"].append(("red_brick", (29, j + 5)))
        for j in range(3):
            self.level_items["tiles"].append(("red_brick", (30, j + 1)))
        for j in range(3):
            self.level_items["tiles"].append(("red_brick", (31, j + 1)))
        for j in range(3):
            self.level_items["tiles"].append(("red_brick", (32, j + 6)))
        for j in range(6):
            self.level_items["tiles"].append(("red_brick", (37, j + 3)))
        for i in range(3):
            self.level_items["tiles"].append(("red_brick", (i, 9)))
        for i in range(16):
            self.level_items["tiles"].append(("red_brick", (i + 22, 9)))
        for i in range(17):
            self.level_items["tiles"].append(("red_brick", (33 + i, 2)))
        for i in range(3):
            self.level_items["tiles"].append(("purple_horizontal", (i + 4, 7)))
        for i in range(3):
            self.level_items["tiles"].append(("purple_horizontal", (i + 8, 4)))
        for i in range(5):
            self.level_items["tiles"].append(("purple_horizontal", (16 + i, 5)))
        purple_horizontal_singles = [(1, 3), (4, 3), (2, 5), (3, 5), (13, 3), (11, 6), (13, 8)]
        for location in purple_horizontal_singles:
            self.level_items["tiles"].append(("purple_horizontal", location))
        ...
        for location in red_brick_singles:
            self.level_items["tiles"].append(("red_brick", location))

        self.level_items["hazard_list"] = []
        for i in range(6):
            self.level_items["hazard_list"].append(("fire", (i + 3, 9)))
        for i in range(4):
            self.level_items["hazard_list"].append(("fire", (i + 10, 9)))
        for i in range(7):
            self.level_items["hazard_list"].append(("water", (i + 15, 9)))
        for i in range(12):
            self.level_items["hazard_list"].append(("fire", (i + 38, 9)))
        for j in range(5):
            self.level_items["hazard_list"].append(("purple_fire", (38, j + 3)))
        for j in range(5):
            self.level_items["hazard_list"].append(("purple_fire", (40, j + 3)))
        for j in range(5):
            self.level_items["hazard_list"].append(("purple_fire", (42, j + 3)))
        for j in range(3):
            self.level_items["hazard_list"].append(("purple_fire", (46, j + 4)))
        purple_fires = [(39, 3), (39, 5), (43, 3), (43, 5), (43, 7), (47, 3), (48, 3), (47, 7), (48, 7),
                        (44, 4), (44, 6)]
        for location in purple_fires:
            self.level_items["hazard_list"].append(("purple_fire", location))

        for gem in self.level_items["gems"]:
            self.gems.create_tile(*gem)
        for tile in self.level_items["tiles"]:
            self.tiles.create_tile(*tile)
        for i, hazard in enumerate(self.level_items["hazard_list"]):
...
class Level3:
    ...
    def __init__(self):
        ...
        self.level_items["gems"] = [("jetpack", (66, 8)), ("trophy", (67, 8)), ("gun", (10, 3)), ("ring", (64, 1)),
                                    ("wand", (71, 5)), ("crown", (71, 4)), ("wand", (72, 0)), ("wand", (74, 1))]
        for i in range(4):
            self.level_items["gems"].append(("wand", (76 + i * 3, 2)))
        self.level_items["blue_gems"] = [1, 5, 14, 19, 23, 28, 52, 56]
        for x in self.level_items["blue_gems"]:
            self.level_items["gems"].append(("blue_gem", (x, 3)))

        for i in range(3):
            self.level_items["gems"].append(("blue_gem", (35 + i * 5, 3)))

        self.level_items["tiles"] = [("horizontal_pipe", (1, 5)), ("dirt", (63, 4)), ("dirt", (66, 4))]
        self.level_items["dirt_list"] = [("ul", (72, 8)), ("ul", (73, 7)), ("ur", (70, 2)), ("ur", (75, 0)),
                                         ("ur", (76, 1)), ("ur", (85, 4))]
        for i in range(3):
            self.level_items["dirt_list"].append(("ll", (71 + i, i)))
        for location in self.level_items["dirt_list"]:
            self.level_items["tiles"].append((f"dirt_{location[0]}", location[1]))

        for j in range(10):
            self.level_items["tiles"].append(("dirt", (0, j)))
        for j in range(10):
            self.level_items["tiles"].append(("dirt", (86, j)))
        for i in range(71):
            self.level_items["tiles"].append(("dirt", (i, 0)))
        for i in range(64):
            self.level_items["tiles"].append(("dirt", (i, 1)))
        for i in range(63):
            self.level_items["tiles"].append(("dirt", (i, 7)))
        for i in range(64):
            self.level_items["tiles"].append(("dirt", (i, 8)))
        for i in range(71):
            self.level_items["tiles"].append(("dirt", (i, 9)))
        for i in range(71, 87):
            self.level_items["tiles"].append(("dirt", (i, 3)))
        for i in range(2):
            for j in range(2):
                self.level_items["tiles"].append(("dirt", (70 + i + j, j + 1)))
        for i in range(76, 86):
            for j in range(2):
                self.level_items["tiles"].append(("dirt", (i + j, j)))
        for j in range(3):
            for i in range(2):
                self.level_items["tiles"].append(("dirt", (72 + i - j, 6 + j)))
        for j in [2, 6]:
            for i in range(1, 62):
                self.level_items["tiles"].append(("blue_pillar", (i, j)))

        self.level_items["hazard_list"] = []
        for i in range(3):
            self.level_items["hazard_list"].append(("purple_fire", (5 + i * 4, 5)))
        for i in range(5):
            self.level_items["hazard_list"].append(("purple_fire", (19 + i * 4, 5)))
        for i in range(3):
            self.level_items["hazard_list"].append(("purple_fire", (36 + i * 4, 5)))
        for j in range(3):
            for i in range(2):
                self.level_items["hazard_list"].append(("fire", (62 + j + i * (9 - 2 * j), 6 + j)))
                self.level_items["hazard_list"].append(("fire", (63 + j + i * (7 - 2 * j), 6 + j)))
        for i in range(71, 84):
            self.level_items["hazard_list"].append(("fire", (i, 9)))
...
class Level4:
    ...
    def __init__(self):
        ...
        self.level_items["gems"] = [("trophy", (6, 1)), ("red_gem", (48, 1)), ("red_gem", (54, 5)),
        ...
        for gem_location in blue_gems:
            self.level_items["gems"].append(("blue_gem", gem_location))

        self.level_items["tiles"] = [("vertical_pipe", (1, 4))]
        ...
        for brick_location in blue_bricks:
            self.level_items["tiles"].append(("blue_brick", brick_location))

        self.level_items["hazard_list"] = [("fire", (3, 5)), ("fire", (4, 5)), ("water", (50, 2)), ("water", (54, 6)),
                                           ("water", (67, 2)), ("water", (70, 2)), ("purple_fire", (78, 6)),
                                           ("purple_fire", (93, 5)), ("purple_fire", (94, 5))]
        for i in range(8):
            self.level_items["hazard_list"].append(("fire", (28 + i, 9)))
        for j in range(3):
            self.level_items["hazard_list"].append(("water", (58, 4 + j)))
        for i in range(3):
            self.level_items["hazard_list"].append(("purple_fire", (87 + i, 5)))
...
class Level5:
    ...
    def __init__(self):
        ...
        self.level_items["gems"] = [("purple_gem", (3, 4)), ("purple_gem", (5, 4)), ("gun", (15, 6)),
        ...
        self.level_items["tiles"] = [("dirt_ll", (0, 0)), ("horizontal_pipe", (1, 8)), ("dirt_ul", (60, 3)),
        ...
        for location in dirt_locations:
            self.level_items["tiles"].append(("dirt", location))
        for location in clay_locations:
            self.level_items["tiles"].append(("clay", location))

        self.level_items["hazard_list"] = [("purple_fire", (71, 5)), ("purple_fire", (72, 8)), ("purple_fire", (74, 7)),
                                           ("purple_fire", (76, 8))]
        for i in range(17):
            self.level_items["hazard_list"].append(("water", (25 + i, 9)))
        for i in range(10):
            self.level_items["hazard_list"].append(("fire", (55 + i, 9)))
        for i in range(3):
            self.level_items["hazard_list"].append(("water", (67 + i, 8)))

        self.level_items["decoration_list"] = []
        ...
        for location in grass_locations:
            self.level_items["decoration_list"].append(("grass", location))

        self.level_items["climbable_list"] = [("leaves_ur", (2, 3)), ("leaves_ul", (6, 3)), ("leaves_br", (2, 1)),
                                              ...
                                              ("leaves_bl", (82, 2)), ]
        self.level_items["leaf_list"] = [(81, 2), (81, 4)]
        self.level_items["star_list"] = [(1, 4), (2, 0), (8, 0), (8, 2), (10, 1), (12, 0), (13, 2), (14, 1), (16, 2),
                                         (17, 1), (19, 0), (21, 2), (23, 0), (24, 1), (26, 0), (28, 1), (30, 0),
                                         (33, 0), (36, 0), (39, 1), (40, 0), (47, 0), (48, 1), (50, 1), (51, 0),
                                         (53, 0)]
        for i in range(3):
            self.level_items["leaf_list"].append((3 + i, 3))
        for j in range(3):
            for i in range(1 + 2 * j):
                self.level_items["leaf_list"].append((4 + i - j, j))
        for i in range(3):
            self.level_items["leaf_list"].append((42 + i, 2))
        for i in range(3):
            self.level_items["leaf_list"].append((80 + i, 3))
        for j in range(2):
            for i in range(5):
                self.level_items["leaf_list"].append((41 + i, j))
        for location in self.level_items["leaf_list"]:
            self.level_items["climbable_list"].append(("leaves", location))
        for location in self.level_items["star_list"]:
            self.level_items["climbable_list"].append(("stars", location))
        for j in range(5):
            self.level_items["climbable_list"].append(("tree_trunk", (4, 4 + j)))
        for j in range(4):
            self.level_items["climbable_list"].append(("tree_trunk", (43, 3 + j)))
        for j in range(4):
            self.level_items["climbable_list"].append(("tree_trunk", (81, 5 + j)))
        ...
        for i, hazard in enumerate(self.level_items["hazard_list"]):
            ...
            sprite.frame = i % len(sprite.images)
        self.mobs = Mobs()
        for decoration in self.level_items["decoration_list"]:
            self.decorations.create_tile(*decoration)
        for climable in self.level_items["climbable_list"]:
